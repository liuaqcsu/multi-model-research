...
usage: download-images.py [-h] [--url-dir URL_DIR] [--images-dir IMAGES_DIR] [--provider {all,google,bing,yahoo}] [--num-images NUM_IMAGES] [--workers WORKERS]
optional arguments:
...
for provider in providers:
    #args.url_dir = 'C:/Users/Stellaliu/Downloads/image-graph_urls/image-graph_urls/'
    args.url_dir = '/home/liuaq/image-graph_urls/'
    ...
    def download_image(i):
        ...
        index = int(index)
        args.images_dir='/home/liuaq/image'
        ...
        if index < args.num_images:  # only use first 25 images (as in the paper)
            ...
            if os.path.exists(os.path.join(target_dir, target_filename)):
                ...
                try:
                    ...
                    temp_filename = 'image-graph_temp'
